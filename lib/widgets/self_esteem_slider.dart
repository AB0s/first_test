...
class SelfEsteemSlider extends StatelessWidget {
  final double selfEsteemLevel;
  final ValueChanged<double> onChanged;
  final Size size;

  const SelfEsteemSlider({
            ...
            child: Column(
              children: [
                Slider(
                  ...
                  max: 1,
                  divisions: 10,
                  label: '${(selfEsteemLevel * 10).round()}',
                ...
                Row(
                  ...
                  children: [
                    Text('Неуверенность', style: TextStyle(fontSize: size.width * 0.035)),
                    Text('Уверенность', style: TextStyle(fontSize: size.width * 0.035)),
                  ],
                ),
              ],
            ),
